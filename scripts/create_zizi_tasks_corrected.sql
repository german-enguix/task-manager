-- Script corregido para crear tareas de Zizi con sistema de evidencias
-- Usa usuarios existentes reales: zizi, german, albert
-- Ejecutar en el panel SQL de Supabase

-- ===============================
-- 0. DIAGNÓSTICO: VERIFICAR ESTRUCTURA DE TABLAS
-- ===============================

-- Verificar qué columnas tienen las tablas principales
...
-- ===============================
-- 2. OBTENER IDS DE USUARIOS EXISTENTES
-- ===============================
...
-- Obtener IDs de usuarios existentes usando JOIN entre auth.users y profiles
-- Ya que profiles no tiene columna email, necesitamos usar auth.users para buscar por email
...
(subtask_id, task1_id, 'Inventario de productos de limpieza', 'Verificar disponibilidad de todos los productos necesarios', false, NOW());
